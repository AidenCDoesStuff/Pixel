...
{
    public class SilverTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("Silver"); // What item drops
            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Silver");
            AddMapEntry(new Color(192, 192, 192), name); // color of tile on map
