...
{
    public class PurpleTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("Purple"); // What item drops
            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Purple");
            AddMapEntry(new Color(128, 0, 128), name); // color of tile on map
