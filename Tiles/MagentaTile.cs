...
{
    public class MagentaTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("Magenta"); // What item drops
            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Magenta");
            AddMapEntry(new Color(255, 0, 255), name); // color of tile on map
